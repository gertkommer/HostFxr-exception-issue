...
#endif
{
   ...
   typedef void (CORECLR_DELEGATE_CALLTYPE* custom_entry_point_fn2)(void(*)());
    custom_entry_point_fn2 InvokeCallBack = nullptr;
    int rc3 = load_assembly_and_get_function_pointer(
       dotnetlib_path.c_str(),
       dotnet_type,
       STR("InvokeCallBack") /*method_name*/,
       STR("DotNetLib.Lib+InvokeCallBackDelegate, DotNetLib") /*delegate_type_name*/,
       nullptr,
       (void**)&InvokeCallBack);
    try {
